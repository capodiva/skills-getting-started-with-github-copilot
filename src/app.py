...
activities = {
    ...
    "Basketball Team": {
        ...
        "max_participants": 15,
        "participants": ["alex@mergington.edu", "mason@mergington.edu", "liam@mergington.edu"]
    },
    "Tennis Club": {
    ...
    "Soccer Club": {
        "description": "Recreational soccer practices and friendly matches",
    ...
    # Artistic activities
    "Art Club": {
        "description": "Explore drawing, painting, sculpture and mixed media projects",
    ...
    "Debate Team": {
        "description": "Debate practice and inter-school tournaments",
...
def signup_for_activity(activity_name: str, email: str):
    ...
    if email in activity["participants"]:
        raise HTTPException(status_code=400, detail=f"{email} is already signed up")
...
def unregister_from_activity(activity_name: str, email: str):
    ...
    # Try to remove the participant; raise 404 if not found
    try:
        activity["participants"].remove(email)
    except ValueError:
        raise HTTPException(status_code=404, detail=f"{email} not found in participants")
